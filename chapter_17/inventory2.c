//
// Created by Derick Alangi on 6/4/21.
//
 ...
 *       command 'q'. Prints an error message if the user enters and illegal  *
 *       code.                                                                *
 ******************************************************************************/
int main(void) {
    char code;
...
/**********************************************************************
 * find_part: Looks up a part number in the inventory list. Returns   *
 *            a pointer to the node containing the part; if the part  *
 ...
 *         sorted by part number. Prints and error message and return   *
...
/*******************************************************************************
 * search: Prompts the user to enter a part number, then looks up the part     *
 *         in the database. If the part exists, prints the name and quantity   *
 ...
 *        part name, & quantity on hand. Parts numbers will appear in ASC order  *
 *********************************************************************************/
void print(void) {
    struct part *p;

...
/********************************************************************************************
 * analyze_hand: Determines whether the hand contains a straight, a flush, four-of-a-king,  *
 ...
 ********************************************************************************************/
 void analyze_hand(void) {
     ...
     for (rank = 0; rank < NUM_RANKS; rank++) {
         ...
         if (num_in_rank[rank] == 2) three = true;
  ...
  *               of the external variables straight, flush, four, three, and pairs  *
  ************************************************************************************/
  void print_result(void) {
